<template>
  <el-container style="height: 100%">
    <el-menu class="el-menu-vertical-demo" :collapse="menuopen" background-color="#19233C" text-color="#fff">
    ...
    <a id="href"></a>
    <el-dialog title="自定义导航" :visible.sync="mynavdialog" width="960px" center :modal="false" id="mynavspace" @close="getmydefinenav">
...
<style>
  ...
  .el-tabs--border-card>.el-tabs__header .el-tabs__item:first-child span{display: none}
</style>
