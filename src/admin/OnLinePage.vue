<template>
  <div class="pagecontent">
    ...
    <cwindow v-model="winvisible" :title="wintitle">
      <!--<cui pk="d0e55ec8-0dda-4d2e-938b-a7d901165d42" v-model="mm"></cui>-->
      <div class="order_input">
        <cinput title="编码" v-model="mm.Code"></cinput>
        <cinput title="名称" v-model="mm.Name"></cinput>
        <cselect title="报表中心" v-model="mm.Fix" pk="YN"></cselect>
  ...
  export default {
    ...
    methods: {
      ...
      btnsave: function (row) {
        let that = this
        if (that.mm.pk_Def === null)that.mm.pk_Def = '9a5a032d-a7c2-4b82-b690-a75b011c17ca'
