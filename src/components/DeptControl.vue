...
<script>
  ...
  export default {
    ...
    created: function () {
      u.querydatacache(this, 'Dept', 'TreeList', null, 'menudata')
    ...
    methods: {
      ...
      btndataload: function (num) {
        ...
        u.querypage(this, 'e237edfd-6ae2-4017-803a-a77b015e863c', this.pagesize, this.pagenum, this.querylist, 'tabledata')
      },
